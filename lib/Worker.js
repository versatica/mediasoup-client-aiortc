...
class Worker extends EnhancedEventEmitter_1.EnhancedEventEmitter {
    ...
    createDataChannel(options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const dataChannelId = v4_1.default();
            const dataChannelInfo = yield this._channel.request('createDataChannel', { dataChannelId }, {
                label: '',
            ...
            return new FakeRTCDataChannel_1.FakeRTCDataChannel({
                dataChannelId
            }, this._channel, {
