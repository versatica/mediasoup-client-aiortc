...
class Worker extends EnhancedEventEmitter_1.EnhancedEventEmitter {
    ...
    getMid(trackId) {
        return __awaiter(this, void 0, void 0, function* () {
            logger.debug('getMid()');
            try {
                const mid = yield this._channel.request('getMid', undefined, { trackId });
                return mid;
            }
            catch (error) {
                return undefined;
    ...
    createDataChannel(options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const { streamId, ordered, maxPacketLifeTime, maxRetransmits, label, protocol, readyState, bufferedAmount, bufferedAmountLowThreshold } = yield this._channel.request('createDataChannel', internal, {
                id: options.streamId,
    ...
    getSenderStats(trackId) {
        return __awaiter(this, void 0, void 0, function* () {
            const data = yield this._channel.request('getSenderStats', undefined, { trackId });
            return new FakeRTCStatsReport_1.FakeRTCStatsReport(data);
        });
    }
    getReceiverStats(mid) {
        return __awaiter(this, void 0, void 0, function* () {
            const data = yield this._channel.request('getReceiverStats', undefined, { mid });
            if (!data)
