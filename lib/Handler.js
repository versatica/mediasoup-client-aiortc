...
class Handler extends HandlerInterface_1.HandlerInterface {
    ...
    async getNativeRtpCapabilities() {
        ...
        const sdp = await this._channel.request('handler.getNativeRtpCapabilities', this._internal);
    ...
    { track, encodings, codecOptions }) {
        ...
        await this._worker.setRemoteDescription(answer);
    ...
    async receive({ trackId, kind, rtpParameters }) {
        ...
        await this._worker.setRemoteDescription(offer);
