...
const AppMediaStream_1 = require("./AppMediaStream");
async function getAppMedia(channel, constraints = {}) {
    ...
    const stream = new AppMediaStream_1.AppMediaStream(tracks);
...
exports.getAppMedia = getAppMedia;
