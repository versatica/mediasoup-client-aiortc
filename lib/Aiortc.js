...
const utils = __importStar(require("mediasoup-client/src/utils"));
const ortc = __importStar(require("mediasoup-client/src/ortc"));
const sdpCommonUtils = __importStar(require("mediasoup-client/src/handlers/sdp/commonUtils"));
const sdpUnifiedPlanUtils = __importStar(require("mediasoup-client/src/handlers/sdp/unifiedPlanUtils"));
const HandlerInterface_1 = require("mediasoup-client/src/handlers/HandlerInterface");
const RemoteSdp_1 = require("mediasoup-client/src/handlers/sdp/RemoteSdp");
...
class Aiortc extends HandlerInterface_1.HandlerInterface {
    ...
    { track, encodings, codecOptions }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const { sourceType, sourceValue } = track.data;
